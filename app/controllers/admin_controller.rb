class AdminController < ApplicationController
    ...
    def index
        ...
        @quick_stats = {
            ...
            revenue: Order.where(created_at: Time.now.midnight..Time.now).sum(:total).to_i.round,
        ...
        # Caso o @revenue_by_day tenha menos que 7 dias, preenche os dias faltantes
        if @revenue_by_day.count < 7
            ...
            ordered_days_with_current_last = days_of_week[next_day_index..-1] + days_of_week[0..next_day_index - 1]
